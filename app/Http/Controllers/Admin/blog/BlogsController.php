...
class BlogsController extends Controller
{
    ...
    public function deletePost($id){
        ...
        $post = Blog::find($id);
        if($post->delete()){
            if(File::exists(public_path().'admin/post/'.$post->image)){
                File::delete(public_path().'admin/post/'.$post->image);
            }

            if(File::exists(public_path().'admin/post/thumb/'.$post->image)){
                File::delete(public_path().'admin/post/thumb/'.$post->image);
            }
